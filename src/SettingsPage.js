      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your Supabase connection and data backups.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/30">
              <div>
                <p className="font-medium">Supabase Integration</p>
                <p className="text-sm text-muted-foreground">Connected to live trading database</p>
              </div>
